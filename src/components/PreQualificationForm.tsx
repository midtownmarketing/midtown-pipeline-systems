...
const PreQualificationForm = () => {
  ...
  if (submitted) {
    return (
      <section id="qualify" className="py-24 relative">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label className={labelClasses}>
                      Current monthly funded deal volume
                    </label>
                    <select
                      className={inputClasses}
                      value={formData.monthlyVolume || ""}
                      onChange={(e) =>
                        handleChange("monthlyVolume", e.target.value)
                      }
                    >
                    ...
                    {errors.monthlyVolume && (
                      <p className={errorClasses}>{errors.monthlyVolume}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleChange("avgCommission", e.target.value)
                      }
                    >
                    ...
                    {errors.avgCommission && (
                      <p className={errorClasses}>{errors.avgCommission}</p>
                    )}
                  </div>
                  ...
                  <div>
                    <label className={labelClasses}>
                      How quickly do you currently respond to new leads?
                    </label>
                    <select
                      className={inputClasses}
                    ...
                    {errors.responseTime && (
                      <p className={errorClasses}>{errors.responseTime}</p>
                    )}
                  </div>
                  ...
                  <div>
                    <label className={labelClasses}>
                      Can you handle 40+ inbound inquiries per month?
                    </label>
                    <select
                      className={inputClasses}
                      value={formData.inquiryCapacity || ""}
                      onChange={(e) =>
                        handleChange("inquiryCapacity", e.target.value)
                      }
                    >
                    ...
                    {errors.inquiryCapacity && (
                      <p className={errorClasses}>{errors.inquiryCapacity}</p>
                    )}
                  </div>
                </div>
              </div>
