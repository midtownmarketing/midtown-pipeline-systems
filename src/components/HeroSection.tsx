...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Gradient orb */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-10 blur-[120px]" style={{ background: "var(--gradient-primary)" }} />
      ...
      <div className="relative z-10 container max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <p className="section-label mb-6">Midtown Marketing — Mortgage Pipeline Systems</p>
          ...
          <p className="text-lg md:text-xl text-secondary-foreground max-w-2xl mx-auto mb-4 leading-relaxed">
            We install predictable inbound pipeline systems for Canadian mortgage brokers.
            Paid acquisition. 5-minute automated follow-up. 2–4 additional funded deals per month.
          </p>
          
          <p className="text-sm font-mono text-muted-foreground mb-10">
            Canada-Only · Mortgage-Only · Month-to-Month
          </p>
        ...
        >
          {[
            ...
            <div key={metric.label} className="text-center">
              ...
              <p className="text-xs font-mono text-muted-foreground mt-1 uppercase tracking-wider">{metric.label}</p>
            </div>
          ))}
        </motion.div>
      </div>
